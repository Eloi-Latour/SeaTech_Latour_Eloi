...
#define STATE_TOURNE_GAUCHE_PLUS 16
#define STATE_TOURNE_GAUCHE_PLUS_EN_COURS 17
#define STATE_TOURNE_DROITE_PLUS 18
#define STATE_TOURNE_DROITE_PLUS_EN_COURS 19
...
#define OBSTACLE_A_DROITE_EXTREME 4
#define OBSTACLE_A_GAUCHE_EXTREME 5
